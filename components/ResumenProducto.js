  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10 items-center" >
        ...
        <div className="md:w-4/6">
            ...
            <p className="text-ms mt-2 text-gray-500">Subtotal: {formatearDinero(producto.precio * producto.cantidad)}</p>
        </div>
        <div>
            <button 
                type="button" 
            ...
            <button 
                type="button" 
                className="bg-red-700 mt-3 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full"
